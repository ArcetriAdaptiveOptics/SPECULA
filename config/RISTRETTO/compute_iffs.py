...
def compute_and_save_influence_functions(tag:str, pupil_pixels:int, n_acts:int, geom:str='circular',
                                         ...
                                         obsratio:float=0.14, diaratio:float=1.0):
    """
    ...
    oversampling = 4 #3          # Minimum oversampling for FFT computations
...
if __name__ == "__main__":
    Npix = 120
    compute_and_save_influence_functions(tag='dm2k', pupil_pixels=Npix, n_acts=40, geom='alpao', r0=10e-2, obsratio=0.14)
    # compute_and_save_influence_functions(tag='dm1', pupil_pixels=Npix, n_acts=40, geom='circular', r0=10e-2)
    # compute_and_save_influence_functions(tag='dm2', pupil_pixels=Npix, n_acts=32, geom='alpao', r0=10e-2)

    # Npix = 69
    # compute_and_save_influence_functions(tag='scratch1', pupil_pixels=Npix, n_acts=9, geom='circular', r0=10e-2, obsratio=0.3)
    # compute_and_save_influence_functions(tag='scratch2', pupil_pixels=Npix, n_acts=9, geom='alpao', r0=10e-2, obsratio=0.3)
    # compute_and_save_influence_functions(tag='scratch3', pupil_pixels=Npix, n_acts=9, geom='square', r0=10e-2, obsratio=0.3)
