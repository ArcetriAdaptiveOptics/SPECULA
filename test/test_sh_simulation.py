...
class TestShSimulation(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if os.path.exists('test/calib/phasescreens/ps_seed1_dim1024_pixpit0.016_L025.0000_single.fits'):
            os.remove('test/calib/phasescreens/ps_seed1_dim1024_pixpit0.016_L025.0000_single.fits')
