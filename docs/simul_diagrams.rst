...
Here are some example of simulation diagrams generated by the simul class.
...
Another example is the diagram corresponding to the parameters file ``main/scao/params_control_lpf.yml`` is:
